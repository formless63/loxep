...
**Implementation status — milestones 1 and 2 are IMPLEMENTED and PROVISIONAL (loxep-lmy.1, loxep-lmy.2).** Milestone 3 remains design only. What shipped, what diverged, and what the owner still has to decide:
