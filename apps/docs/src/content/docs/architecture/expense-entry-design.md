...
M4  OCR tier A — searchable text      migration D. NO new container: tesseract.js v7
                                      ...
                                      language data, poppler pdftotext for existing PDF
                                      text layers, the extraction job, parsed_text +
                                      tsvector, the q filters on /finance/import and
                                      /finance/expenses. Measure error on real receipts
                                      FIRST. OWNER-GATED on open question 1.
