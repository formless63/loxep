...
M4  Documents and intake review       migration. Depends on M2 (a confirm target must
                                      ...
                                      inventory_items path (confirmCandidatesAsIntake,
                                      as distinct from the candidate -> acquisition_costs
                                      path M6 built) remains unbuilt.
