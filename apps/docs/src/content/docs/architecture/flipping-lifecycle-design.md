...
M4  Documents and intake review       migration. Depends on M2 (a confirm target must
                                      exist). documents + candidates, the manual-assisted
                                      parser, the review queue, CSV expense import, and
                                      the confirm functions in accounting and inventory.
